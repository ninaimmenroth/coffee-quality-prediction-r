...
explainer_svm <- explain(
  model = svm_model,
  data = test_data[, -which(names(test_data) == "Cupper.Points")], # Predictors only
  y = test_data$Cupper.Points,                                   # Actual target
...
#### Partial Dependence Plot (PDP) --Not recommended for correlated features!
...
ALE is a better option to see the feature importance in a model who has correlated features.
...
#### SHAP
#### Local Explanation (Why this specific cup of coffee?)
