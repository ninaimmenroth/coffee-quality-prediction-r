...
# Read the data 
coffee_data <- read.csv(here("arabica_data_cleaned.csv"), na.strings = c("", "NA"))
...
```{r, plot-svm-pfi-ale, fig.width=7.5, fig.height=2.6}
...
```{r xgb-pfi-pdp-combined, fig.width=6.5, fig.height=2.2, out.width="95%"}
# PFI plot
...
```{r shapviz-plots, fig.width=6, fig.height=2}
set.seed(SEED)
